...
call oac_alloc(fptr_dev=a1_dev_I8, ubounds=[n            ],ierr=ierr);call error_print(ierr,'a1_dev_I8')
call oac_alloc(fptr_dev=b1_dev_I8, ubounds=[n            ],ierr=ierr);call error_print(ierr,'b1_dev_I8')
call oac_alloc(fptr_dev=a2_dev_I8, ubounds=[n,n          ],ierr=ierr);call error_print(ierr,'a2_dev_I8')
call oac_alloc(fptr_dev=b2_dev_I8, ubounds=[n,n          ],ierr=ierr);call error_print(ierr,'b2_dev_I8')
call oac_alloc(fptr_dev=a3_dev_I8, ubounds=[n,n,n        ],ierr=ierr);call error_print(ierr,'a3_dev_I8')
call oac_alloc(fptr_dev=b3_dev_I8, ubounds=[n,n,n        ],ierr=ierr);call error_print(ierr,'b3_dev_I8')
call oac_alloc(fptr_dev=a4_dev_I8, ubounds=[n,n,n,n      ],ierr=ierr);call error_print(ierr,'a4_dev_I8')
call oac_alloc(fptr_dev=b4_dev_I8, ubounds=[n,n,n,n      ],ierr=ierr);call error_print(ierr,'b4_dev_I8')
call oac_alloc(fptr_dev=a5_dev_I8, ubounds=[n,n,n,n,n    ],ierr=ierr);call error_print(ierr,'a5_dev_I8')
call oac_alloc(fptr_dev=b5_dev_I8, ubounds=[n,n,n,n,n    ],ierr=ierr);call error_print(ierr,'b5_dev_I8')
call oac_alloc(fptr_dev=a6_dev_I8, ubounds=[n,n,n,n,n,n  ],ierr=ierr);call error_print(ierr,'a6_dev_I8')
call oac_alloc(fptr_dev=b6_dev_I8, ubounds=[n,n,n,n,n,n  ],ierr=ierr);call error_print(ierr,'b6_dev_I8')
call oac_alloc(fptr_dev=a7_dev_I8, ubounds=[n,n,n,n,n,n,n],ierr=ierr);call error_print(ierr,'a7_dev_I8')
call oac_alloc(fptr_dev=b7_dev_I8, ubounds=[n,n,n,n,n,n,n],ierr=ierr);call error_print(ierr,'b7_dev_I8')
call oac_alloc(fptr_dev=a1_dev_I4, ubounds=[n            ],ierr=ierr);call error_print(ierr,'a1_dev_I4')
call oac_alloc(fptr_dev=b1_dev_I4, ubounds=[n            ],ierr=ierr);call error_print(ierr,'b1_dev_I4')
call oac_alloc(fptr_dev=a2_dev_I4, ubounds=[n,n          ],ierr=ierr);call error_print(ierr,'a2_dev_I4')
call oac_alloc(fptr_dev=b2_dev_I4, ubounds=[n,n          ],ierr=ierr);call error_print(ierr,'b2_dev_I4')
call oac_alloc(fptr_dev=a3_dev_I4, ubounds=[n,n,n        ],ierr=ierr);call error_print(ierr,'a3_dev_I4')
call oac_alloc(fptr_dev=b3_dev_I4, ubounds=[n,n,n        ],ierr=ierr);call error_print(ierr,'b3_dev_I4')
call oac_alloc(fptr_dev=a4_dev_I4, ubounds=[n,n,n,n      ],ierr=ierr);call error_print(ierr,'a4_dev_I4')
call oac_alloc(fptr_dev=b4_dev_I4, ubounds=[n,n,n,n      ],ierr=ierr);call error_print(ierr,'b4_dev_I4')
call oac_alloc(fptr_dev=a5_dev_I4, ubounds=[n,n,n,n,n    ],ierr=ierr);call error_print(ierr,'a5_dev_I4')
call oac_alloc(fptr_dev=b5_dev_I4, ubounds=[n,n,n,n,n    ],ierr=ierr);call error_print(ierr,'b5_dev_I4')
call oac_alloc(fptr_dev=a6_dev_I4, ubounds=[n,n,n,n,n,n  ],ierr=ierr);call error_print(ierr,'a6_dev_I4')
call oac_alloc(fptr_dev=b6_dev_I4, ubounds=[n,n,n,n,n,n  ],ierr=ierr);call error_print(ierr,'b6_dev_I4')
call oac_alloc(fptr_dev=a7_dev_I4, ubounds=[n,n,n,n,n,n,n],ierr=ierr);call error_print(ierr,'a7_dev_I4')
call oac_alloc(fptr_dev=b7_dev_I4, ubounds=[n,n,n,n,n,n,n],ierr=ierr);call error_print(ierr,'b7_dev_I4')
call oac_alloc(fptr_dev=a1_dev_I1, ubounds=[n            ],ierr=ierr);call error_print(ierr,'a1_dev_I1')
call oac_alloc(fptr_dev=b1_dev_I1, ubounds=[n            ],ierr=ierr);call error_print(ierr,'b1_dev_I1')
call oac_alloc(fptr_dev=a2_dev_I1, ubounds=[n,n          ],ierr=ierr);call error_print(ierr,'a2_dev_I1')
call oac_alloc(fptr_dev=b2_dev_I1, ubounds=[n,n          ],ierr=ierr);call error_print(ierr,'b2_dev_I1')
call oac_alloc(fptr_dev=a3_dev_I1, ubounds=[n,n,n        ],ierr=ierr);call error_print(ierr,'a3_dev_I1')
call oac_alloc(fptr_dev=b3_dev_I1, ubounds=[n,n,n        ],ierr=ierr);call error_print(ierr,'b3_dev_I1')
call oac_alloc(fptr_dev=a4_dev_I1, ubounds=[n,n,n,n      ],ierr=ierr);call error_print(ierr,'a4_dev_I1')
call oac_alloc(fptr_dev=b4_dev_I1, ubounds=[n,n,n,n      ],ierr=ierr);call error_print(ierr,'b4_dev_I1')
call oac_alloc(fptr_dev=a5_dev_I1, ubounds=[n,n,n,n,n    ],ierr=ierr);call error_print(ierr,'a5_dev_I1')
call oac_alloc(fptr_dev=b5_dev_I1, ubounds=[n,n,n,n,n    ],ierr=ierr);call error_print(ierr,'b5_dev_I1')
call oac_alloc(fptr_dev=a6_dev_I1, ubounds=[n,n,n,n,n,n  ],ierr=ierr);call error_print(ierr,'a6_dev_I1')
call oac_alloc(fptr_dev=b6_dev_I1, ubounds=[n,n,n,n,n,n  ],ierr=ierr);call error_print(ierr,'b6_dev_I1')
call oac_alloc(fptr_dev=a7_dev_I1, ubounds=[n,n,n,n,n,n,n],ierr=ierr);call error_print(ierr,'a7_dev_I1')
call oac_alloc(fptr_dev=b7_dev_I1, ubounds=[n,n,n,n,n,n,n],ierr=ierr);call error_print(ierr,'b7_dev_I1')
...
call oac_memcpy_to_device(fptr_src=a1_I8, fptr_dst=a1_dev_I8)
call oac_memcpy_to_device(fptr_src=a2_I8, fptr_dst=a2_dev_I8)
call oac_memcpy_to_device(fptr_src=a3_I8, fptr_dst=a3_dev_I8)
call oac_memcpy_to_device(fptr_src=a4_I8, fptr_dst=a4_dev_I8)
call oac_memcpy_to_device(fptr_src=a5_I8, fptr_dst=a5_dev_I8)
call oac_memcpy_to_device(fptr_src=a6_I8, fptr_dst=a6_dev_I8)
call oac_memcpy_to_device(fptr_src=a7_I8, fptr_dst=a7_dev_I8)
call oac_memcpy_to_device(fptr_src=a1_I4, fptr_dst=a1_dev_I4)
call oac_memcpy_to_device(fptr_src=a2_I4, fptr_dst=a2_dev_I4)
call oac_memcpy_to_device(fptr_src=a3_I4, fptr_dst=a3_dev_I4)
call oac_memcpy_to_device(fptr_src=a4_I4, fptr_dst=a4_dev_I4)
call oac_memcpy_to_device(fptr_src=a5_I4, fptr_dst=a5_dev_I4)
call oac_memcpy_to_device(fptr_src=a6_I4, fptr_dst=a6_dev_I4)
call oac_memcpy_to_device(fptr_src=a7_I4, fptr_dst=a7_dev_I4)
call oac_memcpy_to_device(fptr_src=a1_I1, fptr_dst=a1_dev_I1)
call oac_memcpy_to_device(fptr_src=a2_I1, fptr_dst=a2_dev_I1)
call oac_memcpy_to_device(fptr_src=a3_I1, fptr_dst=a3_dev_I1)
call oac_memcpy_to_device(fptr_src=a4_I1, fptr_dst=a4_dev_I1)
call oac_memcpy_to_device(fptr_src=a5_I1, fptr_dst=a5_dev_I1)
call oac_memcpy_to_device(fptr_src=a6_I1, fptr_dst=a6_dev_I1)
call oac_memcpy_to_device(fptr_src=a7_I1, fptr_dst=a7_dev_I1)
...
call oac_memcpy_from_device(fptr_src=b1_dev_I8, fptr_dst=b1_I8)
call oac_memcpy_from_device(fptr_src=b2_dev_I8, fptr_dst=b2_I8)
call oac_memcpy_from_device(fptr_src=b3_dev_I8, fptr_dst=b3_I8)
call oac_memcpy_from_device(fptr_src=b4_dev_I8, fptr_dst=b4_I8)
call oac_memcpy_from_device(fptr_src=b5_dev_I8, fptr_dst=b5_I8)
call oac_memcpy_from_device(fptr_src=b6_dev_I8, fptr_dst=b6_I8)
call oac_memcpy_from_device(fptr_src=b7_dev_I8, fptr_dst=b7_I8)
call oac_memcpy_from_device(fptr_src=b1_dev_I4, fptr_dst=b1_I4)
call oac_memcpy_from_device(fptr_src=b2_dev_I4, fptr_dst=b2_I4)
call oac_memcpy_from_device(fptr_src=b3_dev_I4, fptr_dst=b3_I4)
call oac_memcpy_from_device(fptr_src=b4_dev_I4, fptr_dst=b4_I4)
call oac_memcpy_from_device(fptr_src=b5_dev_I4, fptr_dst=b5_I4)
call oac_memcpy_from_device(fptr_src=b6_dev_I4, fptr_dst=b6_I4)
call oac_memcpy_from_device(fptr_src=b7_dev_I4, fptr_dst=b7_I4)
call oac_memcpy_from_device(fptr_src=b1_dev_I1, fptr_dst=b1_I1)
call oac_memcpy_from_device(fptr_src=b2_dev_I1, fptr_dst=b2_I1)
call oac_memcpy_from_device(fptr_src=b3_dev_I1, fptr_dst=b3_I1)
call oac_memcpy_from_device(fptr_src=b4_dev_I1, fptr_dst=b4_I1)
call oac_memcpy_from_device(fptr_src=b5_dev_I1, fptr_dst=b5_I1)
call oac_memcpy_from_device(fptr_src=b6_dev_I1, fptr_dst=b6_I1)
call oac_memcpy_from_device(fptr_src=b7_dev_I1, fptr_dst=b7_I1)
