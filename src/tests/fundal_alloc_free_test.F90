...
contains
   ...
   if (present(init_value)) then
      ...
      call dev_alloc(fptr_dev=a1_R8,                               ubounds=[1            ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'a1_R8')
      call dev_alloc(fptr_dev=b1_R8,lbounds=[-1                  ],ubounds=[1            ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'b1_R8')
      call dev_alloc(fptr_dev=a2_R8,                               ubounds=[1,2          ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'a2_R8')
      call dev_alloc(fptr_dev=b2_R8,lbounds=[-1,-2               ],ubounds=[1,2          ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'b2_R8')
      call dev_alloc(fptr_dev=a3_R8,                               ubounds=[1,2,3        ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'a3_R8')
      call dev_alloc(fptr_dev=b3_R8,lbounds=[-1,-2,-3            ],ubounds=[1,2,3        ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'b3_R8')
      call dev_alloc(fptr_dev=a4_R8,                               ubounds=[1,2,3,4      ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'a4_R8')
      call dev_alloc(fptr_dev=b4_R8,lbounds=[-1,-2,-3,-4         ],ubounds=[1,2,3,4      ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'b4_R8')
      call dev_alloc(fptr_dev=a5_R8,                               ubounds=[1,2,3,4      ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'a5_R8')
      call dev_alloc(fptr_dev=b5_R8,lbounds=[-1,-2,-3,-4,-5      ],ubounds=[1,2,3,4,5    ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'b5_R8')
      call dev_alloc(fptr_dev=a6_R8,                               ubounds=[1,2,3,4      ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'a6_R8')
      call dev_alloc(fptr_dev=b6_R8,lbounds=[-1,-2,-3,-4,-5,-6   ],ubounds=[1,2,3,4,5,6  ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'b6_R8')
      call dev_alloc(fptr_dev=a7_R8,                               ubounds=[1,2,3,4      ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'a7_R8')
      call dev_alloc(fptr_dev=b7_R8,lbounds=[-1,-2,-3,-4,-5,-6,-7],ubounds=[1,2,3,4,5,6,7],ierr=ierr,init_value=init_value)
      call error_print(ierr,'b7_R8')
   else
      print '(A)', 'test dev_alloc R8P without initial value'
      call dev_alloc(fptr_dev=a1_R8,                               ubounds=[1            ],ierr=ierr);call error_print(ierr,'a1_R8')
      call dev_alloc(fptr_dev=b1_R8,lbounds=[-1                  ],ubounds=[1            ],ierr=ierr);call error_print(ierr,'b1_R8')
      call dev_alloc(fptr_dev=a2_R8,                               ubounds=[1,2          ],ierr=ierr);call error_print(ierr,'a2_R8')
      call dev_alloc(fptr_dev=b2_R8,lbounds=[-1,-2               ],ubounds=[1,2          ],ierr=ierr);call error_print(ierr,'b2_R8')
      call dev_alloc(fptr_dev=a3_R8,                               ubounds=[1,2,3        ],ierr=ierr);call error_print(ierr,'a3_R8')
      call dev_alloc(fptr_dev=b3_R8,lbounds=[-1,-2,-3            ],ubounds=[1,2,3        ],ierr=ierr);call error_print(ierr,'b3_R8')
      call dev_alloc(fptr_dev=a4_R8,                               ubounds=[1,2,3,4      ],ierr=ierr);call error_print(ierr,'a4_R8')
      call dev_alloc(fptr_dev=b4_R8,lbounds=[-1,-2,-3,-4         ],ubounds=[1,2,3,4      ],ierr=ierr);call error_print(ierr,'b4_R8')
      call dev_alloc(fptr_dev=a5_R8,                               ubounds=[1,2,3,4,5    ],ierr=ierr);call error_print(ierr,'a5_R8')
      call dev_alloc(fptr_dev=b5_R8,lbounds=[-1,-2,-3,-4,-5      ],ubounds=[1,2,3,4,5    ],ierr=ierr);call error_print(ierr,'b5_R8')
      call dev_alloc(fptr_dev=a6_R8,                               ubounds=[1,2,3,4,5,6  ],ierr=ierr);call error_print(ierr,'a6_R8')
      call dev_alloc(fptr_dev=b6_R8,lbounds=[-1,-2,-3,-4,-5,-6   ],ubounds=[1,2,3,4,5,6  ],ierr=ierr);call error_print(ierr,'b6_R8')
      call dev_alloc(fptr_dev=a7_R8,                               ubounds=[1,2,3,4,5,6,7],ierr=ierr);call error_print(ierr,'a7_R8')
      call dev_alloc(fptr_dev=b7_R8,lbounds=[-1,-2,-3,-4,-5,-6,-7],ubounds=[1,2,3,4,5,6,7],ierr=ierr);call error_print(ierr,'b7_R8')
   endif
   ...
   if (present(init_value)) then
      ...
      call dev_alloc(fptr_dev=a1_R4,                               ubounds=[1            ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'a1_R4')
      call dev_alloc(fptr_dev=b1_R4,lbounds=[-1                  ],ubounds=[1            ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'b1_R4')
      call dev_alloc(fptr_dev=a2_R4,                               ubounds=[1,2          ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'a2_R4')
      call dev_alloc(fptr_dev=b2_R4,lbounds=[-1,-2               ],ubounds=[1,2          ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'b2_R4')
      call dev_alloc(fptr_dev=a3_R4,                               ubounds=[1,2,3        ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'a3_R4')
      call dev_alloc(fptr_dev=b3_R4,lbounds=[-1,-2,-3            ],ubounds=[1,2,3        ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'b3_R4')
      call dev_alloc(fptr_dev=a4_R4,                               ubounds=[1,2,3,4      ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'a4_R4')
      call dev_alloc(fptr_dev=b4_R4,lbounds=[-1,-2,-3,-4         ],ubounds=[1,2,3,4      ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'b4_R4')
      call dev_alloc(fptr_dev=a5_R4,                               ubounds=[1,2,3,4,5    ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'a5_R4')
      call dev_alloc(fptr_dev=b5_R4,lbounds=[-1,-2,-3,-4,-5      ],ubounds=[1,2,3,4,5    ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'b5_R4')
      call dev_alloc(fptr_dev=a6_R4,                               ubounds=[1,2,3,4,5,6  ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'a6_R4')
      call dev_alloc(fptr_dev=b6_R4,lbounds=[-1,-2,-3,-4,-5,-6   ],ubounds=[1,2,3,4,5,6  ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'b6_R4')
      call dev_alloc(fptr_dev=a7_R4,                               ubounds=[1,2,3,4,5,6,7],ierr=ierr,init_value=init_value)
      call error_print(ierr,'a7_R4')
      call dev_alloc(fptr_dev=b7_R4,lbounds=[-1,-2,-3,-4,-5,-6,-7],ubounds=[1,2,3,4,5,6,7],ierr=ierr,init_value=init_value)
      call error_print(ierr,'b7_R4')
   else
      print '(A)', 'test dev_alloc R4P without initial value'
      call dev_alloc(fptr_dev=a1_R4,                               ubounds=[1            ],ierr=ierr);call error_print(ierr,'a1_R4')
      call dev_alloc(fptr_dev=b1_R4,lbounds=[-1                  ],ubounds=[1            ],ierr=ierr);call error_print(ierr,'b1_R4')
      call dev_alloc(fptr_dev=a2_R4,                               ubounds=[1,2          ],ierr=ierr);call error_print(ierr,'a2_R4')
      call dev_alloc(fptr_dev=b2_R4,lbounds=[-1,-2               ],ubounds=[1,2          ],ierr=ierr);call error_print(ierr,'b2_R4')
      call dev_alloc(fptr_dev=a3_R4,                               ubounds=[1,2,3        ],ierr=ierr);call error_print(ierr,'a3_R4')
      call dev_alloc(fptr_dev=b3_R4,lbounds=[-1,-2,-3            ],ubounds=[1,2,3        ],ierr=ierr);call error_print(ierr,'b3_R4')
      call dev_alloc(fptr_dev=a4_R4,                               ubounds=[1,2,3,4      ],ierr=ierr);call error_print(ierr,'a4_R4')
      call dev_alloc(fptr_dev=b4_R4,lbounds=[-1,-2,-3,-4         ],ubounds=[1,2,3,4      ],ierr=ierr);call error_print(ierr,'b4_R4')
      call dev_alloc(fptr_dev=a5_R4,                               ubounds=[1,2,3,4,5    ],ierr=ierr);call error_print(ierr,'a5_R4')
      call dev_alloc(fptr_dev=b5_R4,lbounds=[-1,-2,-3,-4,-5      ],ubounds=[1,2,3,4,5    ],ierr=ierr);call error_print(ierr,'b5_R4')
      call dev_alloc(fptr_dev=a6_R4,                               ubounds=[1,2,3,4,5,6  ],ierr=ierr);call error_print(ierr,'a6_R4')
      call dev_alloc(fptr_dev=b6_R4,lbounds=[-1,-2,-3,-4,-5,-6   ],ubounds=[1,2,3,4,5,6  ],ierr=ierr);call error_print(ierr,'b6_R4')
      call dev_alloc(fptr_dev=a7_R4,                               ubounds=[1,2,3,4,5,6,7],ierr=ierr);call error_print(ierr,'a7_R4')
      call dev_alloc(fptr_dev=b7_R4,lbounds=[-1,-2,-3,-4,-5,-6,-7],ubounds=[1,2,3,4,5,6,7],ierr=ierr);call error_print(ierr,'b7_R4')
   endif
   ...
   if (present(init_value)) then
      ...
      call dev_alloc(fptr_dev=a1_I8,                               ubounds=[1            ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'a1_I8')
      call dev_alloc(fptr_dev=b1_I8,lbounds=[-1                  ],ubounds=[1            ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'b1_I8')
      call dev_alloc(fptr_dev=a2_I8,                               ubounds=[1,2          ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'a2_I8')
      call dev_alloc(fptr_dev=b2_I8,lbounds=[-1,-2               ],ubounds=[1,2          ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'b2_I8')
      call dev_alloc(fptr_dev=a3_I8,                               ubounds=[1,2,3        ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'a3_I8')
      call dev_alloc(fptr_dev=b3_I8,lbounds=[-1,-2,-3            ],ubounds=[1,2,3        ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'b3_I8')
      call dev_alloc(fptr_dev=a4_I8,                               ubounds=[1,2,3,4      ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'a4_I8')
      call dev_alloc(fptr_dev=b4_I8,lbounds=[-1,-2,-3,-4         ],ubounds=[1,2,3,4      ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'b4_I8')
      call dev_alloc(fptr_dev=a5_I8,                               ubounds=[1,2,3,4,5    ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'a5_I8')
      call dev_alloc(fptr_dev=b5_I8,lbounds=[-1,-2,-3,-4,-5      ],ubounds=[1,2,3,4,5    ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'b5_I8')
      call dev_alloc(fptr_dev=a6_I8,                               ubounds=[1,2,3,4,5,6  ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'a6_I8')
      call dev_alloc(fptr_dev=b6_I8,lbounds=[-1,-2,-3,-4,-5,-6   ],ubounds=[1,2,3,4,5,6  ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'b6_I8')
      call dev_alloc(fptr_dev=a7_I8,                               ubounds=[1,2,3,4,5,6,7],ierr=ierr,init_value=init_value)
      call error_print(ierr,'a7_I8')
      call dev_alloc(fptr_dev=b7_I8,lbounds=[-1,-2,-3,-4,-5,-6,-7],ubounds=[1,2,3,4,5,6,7],ierr=ierr,init_value=init_value)
      call error_print(ierr,'b7_I8')
   else
      print '(A)', 'test dev_alloc I8P without initial value'
      call dev_alloc(fptr_dev=a1_I8,                               ubounds=[1            ],ierr=ierr);call error_print(ierr,'a1_I8')
      call dev_alloc(fptr_dev=b1_I8,lbounds=[-1                  ],ubounds=[1            ],ierr=ierr);call error_print(ierr,'b1_I8')
      call dev_alloc(fptr_dev=a2_I8,                               ubounds=[1,2          ],ierr=ierr);call error_print(ierr,'a2_I8')
      call dev_alloc(fptr_dev=b2_I8,lbounds=[-1,-2               ],ubounds=[1,2          ],ierr=ierr);call error_print(ierr,'b2_I8')
      call dev_alloc(fptr_dev=a3_I8,                               ubounds=[1,2,3        ],ierr=ierr);call error_print(ierr,'a3_I8')
      call dev_alloc(fptr_dev=b3_I8,lbounds=[-1,-2,-3            ],ubounds=[1,2,3        ],ierr=ierr);call error_print(ierr,'b3_I8')
      call dev_alloc(fptr_dev=a4_I8,                               ubounds=[1,2,3,4      ],ierr=ierr);call error_print(ierr,'a4_I8')
      call dev_alloc(fptr_dev=b4_I8,lbounds=[-1,-2,-3,-4         ],ubounds=[1,2,3,4      ],ierr=ierr);call error_print(ierr,'b4_I8')
      call dev_alloc(fptr_dev=a5_I8,                               ubounds=[1,2,3,4,5    ],ierr=ierr);call error_print(ierr,'a5_I8')
      call dev_alloc(fptr_dev=b5_I8,lbounds=[-1,-2,-3,-4,-5      ],ubounds=[1,2,3,4,5    ],ierr=ierr);call error_print(ierr,'b5_I8')
      call dev_alloc(fptr_dev=a6_I8,                               ubounds=[1,2,3,4,5,6  ],ierr=ierr);call error_print(ierr,'a6_I8')
      call dev_alloc(fptr_dev=b6_I8,lbounds=[-1,-2,-3,-4,-5,-6   ],ubounds=[1,2,3,4,5,6  ],ierr=ierr);call error_print(ierr,'b6_I8')
      call dev_alloc(fptr_dev=a7_I8,                               ubounds=[1,2,3,4,5,6,7],ierr=ierr);call error_print(ierr,'a7_I8')
      call dev_alloc(fptr_dev=b7_I8,lbounds=[-1,-2,-3,-4,-5,-6,-7],ubounds=[1,2,3,4,5,6,7],ierr=ierr);call error_print(ierr,'b7_I8')
   endif
   ...
   if (present(init_value)) then
      ...
      call dev_alloc(fptr_dev=a1_I4,                               ubounds=[1            ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'a1_I4')
      call dev_alloc(fptr_dev=b1_I4,lbounds=[-1                  ],ubounds=[1            ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'b1_I4')
      call dev_alloc(fptr_dev=a2_I4,                               ubounds=[1,2          ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'a2_I4')
      call dev_alloc(fptr_dev=b2_I4,lbounds=[-1,-2               ],ubounds=[1,2          ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'b2_I4')
      call dev_alloc(fptr_dev=a3_I4,                               ubounds=[1,2,3        ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'a3_I4')
      call dev_alloc(fptr_dev=b3_I4,lbounds=[-1,-2,-3            ],ubounds=[1,2,3        ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'b3_I4')
      call dev_alloc(fptr_dev=a4_I4,                               ubounds=[1,2,3,4      ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'a4_I4')
      call dev_alloc(fptr_dev=b4_I4,lbounds=[-1,-2,-3,-4         ],ubounds=[1,2,3,4      ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'b4_I4')
      call dev_alloc(fptr_dev=a5_I4,                               ubounds=[1,2,3,4,5    ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'a5_I4')
      call dev_alloc(fptr_dev=b5_I4,lbounds=[-1,-2,-3,-4,-5      ],ubounds=[1,2,3,4,5    ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'b5_I4')
      call dev_alloc(fptr_dev=a6_I4,                               ubounds=[1,2,3,4,5,6  ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'a6_I4')
      call dev_alloc(fptr_dev=b6_I4,lbounds=[-1,-2,-3,-4,-5,-6   ],ubounds=[1,2,3,4,5,6  ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'b6_I4')
      call dev_alloc(fptr_dev=a7_I4,                               ubounds=[1,2,3,4,5,6,7],ierr=ierr,init_value=init_value)
      call error_print(ierr,'a7_I4')
      call dev_alloc(fptr_dev=b7_I4,lbounds=[-1,-2,-3,-4,-5,-6,-7],ubounds=[1,2,3,4,5,6,7],ierr=ierr,init_value=init_value)
      call error_print(ierr,'b7_I4')
   else
      print '(A)', 'test dev_alloc I4P without initial value'
      call dev_alloc(fptr_dev=a1_I4,                               ubounds=[1            ],ierr=ierr);call error_print(ierr,'a1_I4')
      call dev_alloc(fptr_dev=b1_I4,lbounds=[-1                  ],ubounds=[1            ],ierr=ierr);call error_print(ierr,'b1_I4')
      call dev_alloc(fptr_dev=a2_I4,                               ubounds=[1,2          ],ierr=ierr);call error_print(ierr,'a2_I4')
      call dev_alloc(fptr_dev=b2_I4,lbounds=[-1,-2               ],ubounds=[1,2          ],ierr=ierr);call error_print(ierr,'b2_I4')
      call dev_alloc(fptr_dev=a3_I4,                               ubounds=[1,2,3        ],ierr=ierr);call error_print(ierr,'a3_I4')
      call dev_alloc(fptr_dev=b3_I4,lbounds=[-1,-2,-3            ],ubounds=[1,2,3        ],ierr=ierr);call error_print(ierr,'b3_I4')
      call dev_alloc(fptr_dev=a4_I4,                               ubounds=[1,2,3,4      ],ierr=ierr);call error_print(ierr,'a4_I4')
      call dev_alloc(fptr_dev=b4_I4,lbounds=[-1,-2,-3,-4         ],ubounds=[1,2,3,4      ],ierr=ierr);call error_print(ierr,'b4_I4')
      call dev_alloc(fptr_dev=a5_I4,                               ubounds=[1,2,3,4,5    ],ierr=ierr);call error_print(ierr,'a5_I4')
      call dev_alloc(fptr_dev=b5_I4,lbounds=[-1,-2,-3,-4,-5      ],ubounds=[1,2,3,4,5    ],ierr=ierr);call error_print(ierr,'b5_I4')
      call dev_alloc(fptr_dev=a6_I4,                               ubounds=[1,2,3,4,5,6  ],ierr=ierr);call error_print(ierr,'a6_I4')
      call dev_alloc(fptr_dev=b6_I4,lbounds=[-1,-2,-3,-4,-5,-6   ],ubounds=[1,2,3,4,5,6  ],ierr=ierr);call error_print(ierr,'b6_I4')
      call dev_alloc(fptr_dev=a7_I4,                               ubounds=[1,2,3,4,5,6,7],ierr=ierr);call error_print(ierr,'a7_I4')
      call dev_alloc(fptr_dev=b7_I4,lbounds=[-1,-2,-3,-4,-5,-6,-7],ubounds=[1,2,3,4,5,6,7],ierr=ierr);call error_print(ierr,'b7_I4')
   endif
   ...
   if (present(init_value)) then
      ...
      call dev_alloc(fptr_dev=a1_I1,                               ubounds=[1            ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'a1_I1')
      call dev_alloc(fptr_dev=b1_I1,lbounds=[-1                  ],ubounds=[1            ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'b1_I1')
      call dev_alloc(fptr_dev=a2_I1,                               ubounds=[1,2          ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'a2_I1')
      call dev_alloc(fptr_dev=b2_I1,lbounds=[-1,-2               ],ubounds=[1,2          ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'b2_I1')
      call dev_alloc(fptr_dev=a3_I1,                               ubounds=[1,2,3        ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'a3_I1')
      call dev_alloc(fptr_dev=b3_I1,lbounds=[-1,-2,-3            ],ubounds=[1,2,3        ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'b3_I1')
      call dev_alloc(fptr_dev=a4_I1,                               ubounds=[1,2,3,4      ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'a4_I1')
      call dev_alloc(fptr_dev=b4_I1,lbounds=[-1,-2,-3,-4         ],ubounds=[1,2,3,4      ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'b4_I1')
      call dev_alloc(fptr_dev=a5_I1,                               ubounds=[1,2,3,4,5    ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'a5_I1')
      call dev_alloc(fptr_dev=b5_I1,lbounds=[-1,-2,-3,-4,-5      ],ubounds=[1,2,3,4,5    ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'b5_I1')
      call dev_alloc(fptr_dev=a6_I1,                               ubounds=[1,2,3,4,5,6  ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'a6_I1')
      call dev_alloc(fptr_dev=b6_I1,lbounds=[-1,-2,-3,-4,-5,-6   ],ubounds=[1,2,3,4,5,6  ],ierr=ierr,init_value=init_value)
      call error_print(ierr,'b6_I1')
      call dev_alloc(fptr_dev=a7_I1,                               ubounds=[1,2,3,4,5,6,7],ierr=ierr,init_value=init_value)
      call error_print(ierr,'a7_I1')
      call dev_alloc(fptr_dev=b7_I1,lbounds=[-1,-2,-3,-4,-5,-6,-7],ubounds=[1,2,3,4,5,6,7],ierr=ierr,init_value=init_value)
      call error_print(ierr,'b7_I1')
   else
      print '(A)', 'test dev_alloc I1P without initial value'
      call dev_alloc(fptr_dev=a1_I1,                               ubounds=[1            ],ierr=ierr);call error_print(ierr,'a1_I1')
      call dev_alloc(fptr_dev=b1_I1,lbounds=[-1                  ],ubounds=[1            ],ierr=ierr);call error_print(ierr,'b1_I1')
      call dev_alloc(fptr_dev=a2_I1,                               ubounds=[1,2          ],ierr=ierr);call error_print(ierr,'a2_I1')
      call dev_alloc(fptr_dev=b2_I1,lbounds=[-1,-2               ],ubounds=[1,2          ],ierr=ierr);call error_print(ierr,'b2_I1')
      call dev_alloc(fptr_dev=a3_I1,                               ubounds=[1,2,3        ],ierr=ierr);call error_print(ierr,'a3_I1')
      call dev_alloc(fptr_dev=b3_I1,lbounds=[-1,-2,-3            ],ubounds=[1,2,3        ],ierr=ierr);call error_print(ierr,'b3_I1')
      call dev_alloc(fptr_dev=a4_I1,                               ubounds=[1,2,3,4      ],ierr=ierr);call error_print(ierr,'a4_I1')
      call dev_alloc(fptr_dev=b4_I1,lbounds=[-1,-2,-3,-4         ],ubounds=[1,2,3,4      ],ierr=ierr);call error_print(ierr,'b4_I1')
      call dev_alloc(fptr_dev=a5_I1,                               ubounds=[1,2,3,4,5    ],ierr=ierr);call error_print(ierr,'a5_I1')
      call dev_alloc(fptr_dev=b5_I1,lbounds=[-1,-2,-3,-4,-5      ],ubounds=[1,2,3,4,5    ],ierr=ierr);call error_print(ierr,'b5_I1')
      call dev_alloc(fptr_dev=a6_I1,                               ubounds=[1,2,3,4,5,6  ],ierr=ierr);call error_print(ierr,'a6_I1')
      call dev_alloc(fptr_dev=b6_I1,lbounds=[-1,-2,-3,-4,-5,-6   ],ubounds=[1,2,3,4,5,6  ],ierr=ierr);call error_print(ierr,'b6_I1')
      call dev_alloc(fptr_dev=a7_I1,                               ubounds=[1,2,3,4,5,6,7],ierr=ierr);call error_print(ierr,'a7_I1')
      call dev_alloc(fptr_dev=b7_I1,lbounds=[-1,-2,-3,-4,-5,-6,-7],ubounds=[1,2,3,4,5,6,7],ierr=ierr);call error_print(ierr,'b7_I1')
   endif
