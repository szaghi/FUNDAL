...
contains
   ...
   if (present(init_value)) then
      call dev_memcpy_from_device(fptr_src=a1, fptr_dst=a1_h)
      call dev_memcpy_from_device(fptr_src=a2, fptr_dst=a2_h)
      call dev_memcpy_from_device(fptr_src=a3, fptr_dst=a3_h)
      call dev_memcpy_from_device(fptr_src=a4, fptr_dst=a4_h)
      call dev_memcpy_from_device(fptr_src=a5, fptr_dst=a5_h)
      call dev_memcpy_from_device(fptr_src=a6, fptr_dst=a6_h)
      call dev_memcpy_from_device(fptr_src=a7, fptr_dst=a7_h)
      call dev_memcpy_from_device(fptr_src=b1, fptr_dst=b1_h)
      call dev_memcpy_from_device(fptr_src=b2, fptr_dst=b2_h)
      call dev_memcpy_from_device(fptr_src=b3, fptr_dst=b3_h)
      call dev_memcpy_from_device(fptr_src=b4, fptr_dst=b4_h)
      call dev_memcpy_from_device(fptr_src=b5, fptr_dst=b5_h)
      call dev_memcpy_from_device(fptr_src=b6, fptr_dst=b6_h)
      call dev_memcpy_from_device(fptr_src=b7, fptr_dst=b7_h)
