!< FUNDAL, device memory assign test with lower bound -2.

#include "fundal.H"

program fundal_assign_lb_test
!< FUNDAL, device memory assign test with lower bound -2.
...
#include "fundal_assign_lb_test_agnostic.INC"
...
#include "fundal_assign_lb_test_agnostic.INC"
endprogram fundal_assign_lb_test
