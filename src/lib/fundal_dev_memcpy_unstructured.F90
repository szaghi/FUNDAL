...
contains
   ...
   real(R8P), intent(inout) :: dst(:) !< Destination memory (host memory).
   !$acc update self(dst)
   ...
   real(R4P), intent(inout) :: dst(:) !< Destination memory (host memory).
   !$acc update self(dst)
   !$omp target update from(dst)
   ...
   integer(I8P), intent(inout) :: dst(:) !< Destination memory (host memory).
   !$acc update self(dst)
   !$omp target update from(dst)
   ...
   integer(I4P), intent(inout) :: dst(:) !< Destination memory (host memory).
   !$acc update self(dst)
   !$omp target update from(dst)
   ...
   integer(I2P), intent(inout) :: dst(:) !< Destination memory (host memory).
   !$acc update self(dst)
   !$omp target update from(dst)
   ...
   integer(I1P), intent(inout) :: dst(:) !< Destination memory (host memory).
   !$acc update self(dst)
   !$omp target update from(dst)
   ...
   real(R8P), intent(inout) :: dst(:) !< Destination memory (device memory).
   !$acc update device(dst)
   ...
   real(R4P), intent(inout) :: dst(:) !< Destination memory (device memory).
   !$acc update device(dst)
   !$omp target update to(dst)
   ...
   integer(I8P), intent(inout) :: dst(:) !< Destination memory (device memory).
   !$acc update device(dst)
   !$omp target update to(dst)
   ...
   integer(I4P), intent(inout) :: dst(:) !< Destination memory (device memory).
   !$acc update device(dst)
   !$omp target update to(dst)
   ...
   integer(I2P), intent(inout) :: dst(:) !< Destination memory (device memory).
   !$acc update device(dst)
   !$omp target update to(dst)
   ...
   integer(I1P), intent(inout) :: dst(:) !< Destination memory (device memory).
   !$acc update device(dst)
   !$omp target update to(dst)
