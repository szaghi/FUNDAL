...
contains
   ...
   integer(I2P), intent(out), pointer :: fptr_dev(:) !< Pointer to allocated memory.
   integer(I4P), intent(in)           :: ubounds(1)  !< Array upper bounds.
   integer(I4P), intent(out)          :: ierr        !< Error status.
   integer(I4P), intent(in), optional :: dev_id      !< Device ID (not used, necessary for unified OpenMP API).
   integer(I4P), intent(in), optional :: lbounds(1)  !< Array lower bounds, 1 if not passed.
   integer(I2P), intent(in), optional :: init_value  !< Optional initial value.
   integer(I2P), pointer              :: fptr(:)     !< Fortran pointer with lbounds=1.
   type(c_ptr)                        :: cptr_dev    !< C pointer.
   integer(I8P)                       :: sizes(1)    !< Sizes.
   integer(I4P)                       :: lbounds_(1) !< Array lower bounds, local var.
   integer(I4P)                       :: dev_id_     !< Device ID, local variable.
   ...
   endsubroutine dev_alloc_I2P_1D
   ...
   endsubroutine dev_alloc_I2P_2D
   ...
   endsubroutine dev_alloc_I2P_3D
   ...
   endsubroutine dev_alloc_I2P_4D
   ...
   endsubroutine dev_alloc_I2P_5D
   ...
   endsubroutine dev_alloc_I2P_6D
   ...
   endsubroutine dev_alloc_I2P_7D
