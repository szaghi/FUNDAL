...
contains
   ...
   subroutine dev_memcpy_from_device_R8P_2D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_from_device_R8P_3D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_from_device_R8P_4D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_from_device_R8P_5D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_from_device_R8P_6D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_from_device_R8P_7D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_from_device_R4P_1D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_from_device_R4P_2D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_from_device_R4P_3D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_from_device_R4P_4D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_from_device_R4P_5D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_from_device_R4P_6D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_from_device_R4P_7D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_from_device_I8P_1D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_from_device_I8P_2D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_from_device_I8P_3D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_from_device_I8P_4D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_from_device_I8P_5D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_from_device_I8P_6D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_from_device_I8P_7D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_from_device_I4P_1D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_from_device_I4P_2D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_from_device_I4P_3D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_from_device_I4P_4D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_from_device_I4P_5D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_from_device_I4P_6D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_from_device_I4P_7D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_from_device_I1P_1D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_from_device_I1P_2D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_from_device_I1P_3D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_from_device_I1P_4D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_from_device_I1P_5D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_from_device_I1P_6D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_from_device_I1P_7D(fptr_dst, fptr_src)
   ...
   DEVMEMCPY_TO_DEVICE(fptr_dst, fptr_src, bytes)
   endsubroutine dev_memcpy_to_device_R8P_1D

   subroutine dev_memcpy_to_device_R8P_2D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_to_device_R8P_3D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_to_device_R8P_4D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_to_device_R8P_5D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_to_device_R8P_6D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_to_device_R8P_7D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_to_device_R4P_1D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_to_device_R4P_2D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_to_device_R4P_3D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_to_device_R4P_4D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_to_device_R4P_5D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_to_device_R4P_6D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_to_device_R4P_7D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_to_device_I8P_1D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_to_device_I8P_2D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_to_device_I8P_3D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_to_device_I8P_4D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_to_device_I8P_5D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_to_device_I8P_6D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_to_device_I8P_7D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_to_device_I4P_1D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_to_device_I4P_2D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_to_device_I4P_3D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_to_device_I4P_4D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_to_device_I4P_5D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_to_device_I4P_6D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_to_device_I4P_7D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_to_device_I1P_1D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_to_device_I1P_2D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_to_device_I1P_3D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_to_device_I1P_4D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_to_device_I1P_5D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_to_device_I1P_6D(fptr_dst, fptr_src)
   ...
   subroutine dev_memcpy_to_device_I1P_7D(fptr_dst, fptr_src)
